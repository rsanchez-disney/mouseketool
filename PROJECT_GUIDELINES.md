...
1. **Before committing code**, update the Help page (`HelpPage.vue`) and any relevant `.md` files (README, docs/, project-highlights, proposed-changes) to document the new feature.
